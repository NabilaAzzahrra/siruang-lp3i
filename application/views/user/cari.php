                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <form action="<?= base_url('User/cari') ?>" method="GET" enctype="multipart/form-data" accept-charset="UTF-8">
                                <div class="row">
                                    <p class="mb-4 ml-3" style="font-size: 20px;"><strong class="badge badge-success"><?= $day ?>, <?= date('d-m-Y', strtotime($_GET['tgl'])) ?> </strong></p>
                                    <div class="form-group col-md-2">
                                        <input type="date" name="tgl" class="form-control" placeholder="Tanggal" value="<?= $_GET['tgl'] ?>">
                                    </div>
                                    <div class="form-group col-md-2">
...
Kelas : $id_kelas";
                                            ...
                                            if ($cek->num_rows() > 0) {
                                                ...
                                                $this->db->where('hari =', date('l', strtotime($_GET['tgl'])));
                                                // $this->db->where('hari =', date('l'));
                                                $this->db->where('tgl_pakai =', $_GET['tgl']);
...
$empat";
                            ...
                            <div class="modal-body">
                                ...
                                <span id="modal-body-update-or-create">
                                    ...
                                    <div class="form-group" hidden>
                                        ...
                                        <input type="text" name="id_kelas" class="form-control" placeholder="Kelas" value="<?= $p->id_kelas ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group" hidden>
                                        ...
                                        <input type="date" name="tgl_pakai" class="form-control" placeholder="Tanggal Pakai" value="<?= $_GET['tgl'] ?>">
                                    </div>
                                    <div class="form-group" hidden>
                                        <label>Sesi</label>
            ...
            <script>
                function pesan(id_ruang, sesi) {
                    ...
                    $('[name="semester"]').val();
                    document.form.action = '<?= base_url('User/actadd_b_ruang'); ?>';
                }
                ...
                function hapus(id_kelas, kelas) {
                    ...
                    document.form.action = '<?= base_url('User/acthapus_kelas'); ?>';
                }
