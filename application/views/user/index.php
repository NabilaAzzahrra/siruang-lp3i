...
$empat";
                                    ...
                                    ?>
                                        ...
                                        <button type="button" onclick="return pesan(`<?= $r->id_ruang ?>`)" value="<?= $r->id_ruang ?>" title="<?= $r->id_ruang ?>" class="btn btn-<?= $bg ?> btn-sm mr-4" <?= $disab ?> style="height: 100px; width: 100px;"><?= $r->ruang ?></button>
                                    </td> -->
                                            <td class="text-center">
