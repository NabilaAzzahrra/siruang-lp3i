...
<head>
  ...
  <title><?= $title ?></title>
  <link rel="icon" href="https://yt3.googleusercontent.com/YTbtWHaUmX2ZZIqimCKCUdth28WvOR7_7HRAautax_jvG89xIDsW4LPWViFMZhsPWM55bNaoFLI=s900-c-k-c0x00ffffff-no-rj" sizes="any">
  ...
  <link rel="stylesheet" href="<?= base_url('assets/templates'); ?>/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css">
  <!-- Tempusdominus Bootstrap 4 -->
  <link rel="stylesheet" href="<?= base_url('assets/templates'); ?>/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
  <!-- Select2 -->
  <link rel="stylesheet" href="<?= base_url('assets/templates'); ?>/plugins/select2/css/select2.min.css">
  ...
  <link rel="stylesheet" href="<?= base_url('assets/templates'); ?>/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css">
  <!-- BS Stepper -->
  <link rel="stylesheet" href="<?= base_url('assets/templates'); ?>/plugins/bs-stepper/css/bs-stepper.min.css">
  <!-- dropzonejs -->
  <link rel="stylesheet" href="<?= base_url('assets/templates'); ?>/plugins/dropzone/min/dropzone.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="<?= base_url('assets/templates'); ?>/dist/css/adminlte.min.css">
