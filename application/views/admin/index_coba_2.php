                        ...
                        ?>
                            <tr>
                                <td class="text-center">
                                    <button type="button" onclick="return pesan(`<?= $r->id_ruang ?>`)" value="<?= $r->id_ruang ?>" title="<?php
                                                                                                                                            $this->db->select('*');
                                                                                                                                            $this->db->from('b_ruang');
                                                                                                                                            $this->db->join('tahun_akademik', 'tahun_akademik.id_tahun_akademik=b_ruang.id_tahun_akademik');
                                                                                                                                            $this->db->join('konfigurasi', 'konfigurasi.id_tahun_akademik=tahun_akademik.id_tahun_akademik');
...
$empat";
                                                                                                                                            ?> <?= $br->id_b_ruang ?>
                                     <?php }
                                                                                                                                            } ?>" class="btn btn-<?= $bg1 ?> btn-sm mr-4" <?= $disab1 ?> style="height: 100px; width: 100px;"><?= $r->ruang ?></button>
                                </td>
                                <td class="text-center">
