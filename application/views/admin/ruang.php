                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a class="btn btn-success btn-sm" onclick="return edit(`<?= $r->id_ruang ?>`,`<?= $r->ruang ?>`)" href="#">
                                                        <i class="fas fa-edit"></i> Ubah
                                                    </a>
                                                    <a class="btn btn-danger btn-sm" onclick="return hapus(`<?= $r->id_ruang ?>`,`<?= $r->ruang ?>`)" href="#">
            ...
            <script>
                function tambah() {
                    $('#Modal').modal('show');
                    $('#modal-header').html('Tambah Ruang');
                    ...
                    $('[name="id_ruang"]').val();
                    $('[name="ruang"]').val();
                    document.form.action = '<?= base_url('Admin/actadd_ruang'); ?>';
                }


                function edit(id_ruang, ruang) {
                    $('#Modal').modal('show');
                    $('#modal-header').html('Ubah Ruang');
                    $('#batal').removeClass('bg-gradient-success').addClass('bg-gradient-danger');
                    $('#modal-button').removeClass('bg-gradient-danger').addClass('bg-gradient-success');
                    $('#modal-body-update-or-create').removeClass('d-none');
                    $('#modal-body-delete').addClass('d-none');
                    ...
                    document.form.action = '<?= base_url('Admin/actedit_ruang'); ?>';
                }

                function hapus(id_ruang, ruang) {
                    $('#Modal').modal('show');
                    $('#modal-header').html('Hapus Ruang');
                    ...
                    $('[name="id_ruang"]').val(id_ruang);
                    $('#name-delete').html(ruang);
                    document.form.action = '<?= base_url('Admin/acthapus_ruang'); ?>';
                }
            </script>