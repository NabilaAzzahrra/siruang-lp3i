                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a class="btn btn-success btn-sm" onclick="return edit(`<?= $r->id_tahun_akademik ?>`,`<?= $r->tahun_akademik ?>`)" href="#">
                                                        <i class="fas fa-edit"></i> Ubah
                                                    </a>
                                                    <a class="btn btn-danger btn-sm" onclick="return hapus(`<?= $r->id_tahun_akademik ?>`,`<?= $r->tahun_akademik ?>`)" href="#">
            ...
            <script>
                function tambah() {
                    ...
                    $('[name="id_tahun_akademik"]').val();
                    $('[name="tahun_akademik"]').val();
                    document.form.action = '<?= base_url('Admin/actadd_tahun_akademik'); ?>';
                }


                function edit(id_tahun_akademik, tahun_akademik) {
                    $('#Modal').modal('show');
                    ...
                    $('#modal-body-update-or-create').removeClass('d-none');
                    $('#modal-body-delete').addClass('d-none');
                    $('[name="id_tahun_akademik"]').val(id_tahun_akademik);
                    $('[name="tahun_akademik"]').val(tahun_akademik);
                    document.form.action = '<?= base_url('Admin/actedit_tahun_akademik'); ?>';
                }

                function hapus(id_tahun_akademik, tahun_akademik) {
                    $('#Modal').modal('show');
                    ...
                    document.form.action = '<?= base_url('Admin/acthapus_tahun_akademik'); ?>';
                }
            </script>